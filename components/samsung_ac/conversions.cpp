...
Mode str_to_mode(const std::string& value) {
  ...
  if (value == "Cool") return Mode::Cool;
  if (value == "Dry") return Mode::Dry;
  if (value == "Fan") return Mode::Fan;
  if (value == "Heat") return Mode::Heat;
  return Mode::Unknown;
}
...
WaterHeaterMode str_to_water_heater_mode(const std::string& value) {
  if (value == "Eco") return WaterHeaterMode::Eco;
  if (value == "Standard") return WaterHeaterMode::Standard;
  if (value == "Power") return WaterHeaterMode::Power;
  if (value == "Force") return WaterHeaterMode::Force;
...
FanMode customfanmode_to_fanmode(const std::string& value) {
  if (value == "Turbo") return FanMode::Turbo;
  return FanMode::Auto;
}
...
optional<climate::ClimatePreset> altmodename_to_preset(const AltModeName& name) {
  if (str_equals_case_insensitive(name, "ECO")) return optional<climate::ClimatePreset>(climate::CLIMATE_PRESET_ECO);
  if (str_equals_case_insensitive(name, "AWAY")) return optional<climate::ClimatePreset>(climate::CLIMATE_PRESET_AWAY);
  ...
  if (str_equals_case_insensitive(name, "HOME")) return optional<climate::ClimatePreset>(climate::CLIMATE_PRESET_HOME);
  ...
  if (str_equals_case_insensitive(name, "NONE")) return optional<climate::ClimatePreset>(climate::CLIMATE_PRESET_NONE);
  return nullopt;
}
